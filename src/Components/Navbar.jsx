...
function Navbar() {
    ...
    return (
    <>
    <div className='sticky shadow-2xl p-4 text-white'>


      <div className='flex items-center justify-between '>
<div className='md:hidden'>
<img src={Logo} alt="" className='h-10 w-10 ml-5 object-cover bg-blend-overlay rounded-lg' />
</div>
        <div className=''>
      ...
      {isMenuOpen ? (
        <div className='flex-col text-center justify-center  md:hidden '>
          <a href={Logo} className='mt-4 ml-96 text-right border-spacing-2 border-x-2'> X </a>
          <ul className='mt-0' >
           <li>
            ...
            <hr />
            <li>
              <a href="/skills" className='text-2xl ml-4  hover:text-yellow-300'>SKILLS</a>
            </li>
            <hr />
            <li>
